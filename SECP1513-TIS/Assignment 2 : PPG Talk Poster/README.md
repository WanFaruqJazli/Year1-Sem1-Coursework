...
* **Show Real Examples:** It would be cooler if they showed us a real problem PPG faced and how they fixed it using data.
* **More Q&A Time:** We had a lot of questions, so a longer Q&A session would be helpful to learn from the experts.
* **Share the Slides:** It would be great if we could get a copy of the slides to look back at the technical info later.

---

## 📷 Photo Highlights
Here are a few pictures we took during the event.

<div align="center">

**Event Poster**
<br>
<img src="https://github.com/user-attachments/assets/ed6c4c1f-a6ad-4e02-8263-54fb240a9e40" width="400" />
...
## 📎 Post-Talk Assignment
We were asked to design a poster to summarize what we learned from the talk.
